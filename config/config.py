...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/DED-LEGEND/DXX-EXTRAPLUGIN",
)
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/DED-LEGEND/DXX-MUSICBOT",
)
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/DED-LEGEND/DXX-MUSICBOT")
